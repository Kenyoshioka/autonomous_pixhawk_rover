    ...
    def streaming(self):
        ...
        try:
            ...
            while True:
                ...
                measured_distance = vehicle.rangefinder.distance * 100

                # truncate rangefinder reading to 50 [cm]
                if (measured_distance > 50):

                    measured_distance = 50
                
                # convert float to string
                measured_distance = str(measured_distance)
                # send sensor reading to d_distance_client module
                d_distance_client.send_reading(measured_distance)
            ...
            d_distance_client.close_socket()
